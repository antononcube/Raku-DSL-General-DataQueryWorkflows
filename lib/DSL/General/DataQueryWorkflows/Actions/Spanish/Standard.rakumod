...
use DSL::General::DataQueryWorkflows::Actions::Spanish::Predicate;
use DSL::Shared::Actions::English::PipelineCommand;

unit module DSL::General::DataQueryWorkflows::Actions::Spanish::Standard;

class DSL::General::DataQueryWorkflows::Actions::Spanish::Standard
		is DSL::Shared::Actions::English::PipelineCommand
        is DSL::General::DataQueryWorkflows::Actions::Spanish::Predicate {
