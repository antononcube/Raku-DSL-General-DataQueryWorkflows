...
unit module DSL::General::DataQueryWorkflows::Actions::SQL::Standard;

class DSL::General::DataQueryWorkflows::Actions::SQL::Standard
	...
	method workflow-commands-list($/) { make $/.values>>.made }
	...
	method group-by-command($/) { make 'group by' => 'GROUP BY ' ~ $<variable-names-list>.made; }
	...
	method arrange-by-spec($/) { make 'arrange' => $<variable-names-list>.made; }
