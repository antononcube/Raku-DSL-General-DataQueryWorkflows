...
use DSL::General::DataQueryWorkflows::Actions::Bulgarian::Predicate;
use DSL::Shared::Actions::English::PipelineCommand;

unit module DSL::General::DataQueryWorkflows::Actions::Bulgarian::Standard;

class DSL::General::DataQueryWorkflows::Actions::Bulgarian::Standard
		is DSL::Shared::Actions::English::PipelineCommand
        is DSL::General::DataQueryWorkflows::Actions::Bulgarian::Predicate {
	...
	method arrange-simple-command($/) {
        make $<reverse-sort-phrase> || $<descending-phrase> ?? 'сортирай в низходящ ред' !! 'сортирай';
    }
